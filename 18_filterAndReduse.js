...
console.log("====Step: 1. find all the employee from wipro company====");
...
console.log("====Step: 2. find all the employee from IT or HR dept====");
array_employees.forEach( (employee)=> {
    if (employee.emp_dept=="IT" || "HR") {
        console.log(`Emp Id: ${employee.emp_id},Emp Name: ${employee.emp_name}, Emp Dept: ${employee.emp_dept}, Emp Salary: ${employee.emp_salary},  Emp Company: ${employee.emp_company}`);
    }
});

console.log("=======Step: 3. find all the employee whose emp id's are greater than 50=======");
array_employees.forEach( (employee)=> {
...
console.log("=======Step: 4. find all the employee whose whose name start with A, V, or M=======");
...
console.log("========Step: 5. find the average salary of employee for all the department========");
const newArray = []
...
console.log("========Step: 6.find the average salary for IT department========");
const newArray2 = []
array_employees.filter((element)=>{
